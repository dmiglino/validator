...
public class Person {
    ...
    @Name(message = "First name cannot be null or blank or greater than 255 chars") //Custom annotation where you can bundle all validation logic at one place and resue it.
